...
class TextTranslate extends StatefulWidget {
  ...
  ///
  /// See [RichTextTranslate] which provides a lower-level way to draw text.
  TextTranslate.rich(
    this.textSpan, {
    Key key,
    this.style,
...
class _TextTranslateState extends State<TextTranslate> {
  ...
  String langaugeLocale;
  var newData;

  Future apply() async {
    var translation = await translator
        .translate(this.widget.data, from: 'en', to:langaugeLocale )
        .then((value) {
      setState(() {
        newData = value;
      });
  ...
  Widget build(BuildContext context) {
    ...
    langaugeLocale = myLocale.countryCode;
    ...
    Widget result = RichText(
      ...
      text: TextSpan(
        ...
        children:
            widget.textSpan != null ? <InlineSpan>[widget.textSpan] : null,
      ),
    );
